...
def parser_gen():
    ...
    parser.add_argument('--power_scale', action=argparse.BooleanOptionalAction, default=False,
                        help='Power scaling for GPTQ')
    parser.add_argument('--quant_func', type=str, default='int')
